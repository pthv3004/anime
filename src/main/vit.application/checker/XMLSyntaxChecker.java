...
public class XMLSyntaxChecker {
    public String check(String src) {src = src + " ";
            ...
            switch (state) {
                ...
                case CLOSE_BRACKET:
                    if (isOpenTag) {
                        ...
                        writer.append(LT).append(openTagName).append(convert(attributes)).append(isEmptyTag ? "/" : "")
                                .append(GT);
    ...
    private String convert(Map<String, String> attributes) {
        ...
        attributes.forEach((key, value1) -> {
            String value = value1.replace("&", "&amp;").replaceAll("\"", "&quot;").replaceAll("'", "&apos;")
